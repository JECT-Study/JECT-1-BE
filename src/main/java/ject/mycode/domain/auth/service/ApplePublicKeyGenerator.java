...
import ject.mycode.domain.auth.dto.apple.ApplePublicKeyRes;
...
public class ApplePublicKeyGenerator {
    ...
    public PublicKey generate(Map<String, String> headers, ApplePublicKeysRes publicKeys) {
        // id_token에서 추출한 alg, kid와 일치하는 alg, kid를 가진 publicKey
        ApplePublicKeyRes applePublicKey = publicKeys.getMatchingKey(
    ...
    private PublicKey generatePublicKey(ApplePublicKeyRes applePublicKey) {
